  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
      ...
      <div className="flex justify-center my-10 gap-4">
        <button className="bg-gradient-to-r from-orange-500 to-orange-800 py-3 px-4 rounded-md">Start for free</button>
        <button className="py-3 px-4 rounded-md border">Documentation</button>
      </div>
      <div className="flex mt-10 justify-center px-4">
        <video autoPlay loop className="rounded-lg w-1/2 border border-orange-700 shadow-orange-400 mx-2 my-4">
